        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    friendly_code = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11155bbf-75ee-434f-b2bc-f1088a184592"), new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 2, 10, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "Define o estado de entregue no ciclo de vida do processamento de e-mails.", "#ENTREGUE", "EMAS-11178", true, null, null, "Entregue" },
                    { new Guid("1e8f3a82-407b-020e-fc4b-463f4e2cbd72"), new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 2, 10, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "Define o estado de enviado no ciclo de vida do processamento de e-mails.", "#ENVIADO", "EMAS-08303", true, null, null, "Enviado" },
                    { new Guid("9b513552-8e21-ad83-547a-a46ba17bf017"), new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 2, 10, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "Define o estado de falha no ciclo de vida do processamento de e-mails.", "#FALHA", "EMAS-23153", true, null, null, "Falha" },
                    { new Guid("d1de51ec-deea-cfc8-7f85-21794fe22deb"), new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2026, 2, 10, 0, 0, 0, 0, DateTimeKind.Utc), null, null, "Define o estado de pendente no ciclo de vida do processamento de e-mails.", "#PENDENTE", "EMAS-61294", true, null, null, "Pendente" }
                });
